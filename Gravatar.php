...
* 
* @originalauthor Ryan Marshall <ryan@irealms.co.uk>
* @package codeigniter
* @subpackage gravatar
* 
* This project is a specific-use fork of https://github.com/rsmarshall/Codeigniter-Gravatar with a few changes to ease our
* own use of the library.  It is in no way intended to be the primary public library for its function but is available for
* free public use if it better suits anybody's needs as it does ours.  Note that the only fix implemented by this fork in
* is also in the originating repository which is probably more likely to promptly maintain code going forward.
...
/* Location: ./application/libraries/gravatar/gravatar.php */